...
<div class="content-area">
	<main class="site-main modeling">
		...
		<section class="pics">
			<div class="pics__wrapper lcw">
				<div class="pics__item">
					<img src="<?php echo get_template_directory_uri(); ?>/img/services/modeling/1.jpg" alt="" class="pics__img">
					<div class="pics__mask"></div>				
				</div>
				<div class="pics__item pics__item--big">
					<img src="<?php echo get_template_directory_uri(); ?>/img/services/modeling/2.jpg" alt="" class="pics__img">
					<div class="pics__mask"></div>	
				</div>
				<div class="pics__item">
					<img src="<?php echo get_template_directory_uri(); ?>/img/services/modeling/3.jpg" alt="" class="pics__img">
					<div class="pics__mask"></div>	
				</div>
			</div>
		</section>
		<article class="lcw">
			...
			<p>Мы предлагаем разработку трехмерных моделей в программных системах, позволяющих создавать детальные трехмерные конструктивные модели зданий и сооружений любой сложности. Модели могут быть использованы в процессе всего производственного цикла: от эскизов до изготовления, возведения и управления строительством. Опытные инженеры-конструкторы профессионально выполняет моделирование любых объектов независимо от технических параметров изделия. </p>
			<p>Позвоните по телефону <strong>+7 (495) 726-57-22</strong>, чтобы получить профессиональную консультацию от наших специалистов.</p>
		</article>
		<!--<section class="order">
