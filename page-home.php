				...
				<div class="adv__container">
					<div class="adv__item">
						<div class="adv__inner">
							<div class="adv__circle">
								<div class="adv__img"></div>
							</div>
							<h2 class="adv__header">Специалисты</h2>
							<p class="adv__text">Сотрудники нашей компании имеют многолетний опыт проектирования сооружений различной сложности.</p>
						</div>
					</div>
					<div class="adv__item">
						<div class="adv__inner">
					...
					<div class="adv__item">
						<div class="adv__inner">
							...
							<h2 class="adv__header">ГОСТ ЕСКД</h2>
							<p class="adv__text">Разрабатываемые нами чертежи строго соответствуют единой системе конструкторской документации.</p>
						</div>
					</div>
					<div class="adv__item">
						<div class="adv__inner">
							...
							<h2 class="adv__header">Сроки</h2>
							<p class="adv__text">Гарантия четкого соблюдения сроков выполнения работ является нашей приоритетной задачей.</p>
						</div>
					</div>					
				</div>
			</div>
